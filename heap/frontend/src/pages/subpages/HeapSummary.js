...
// Sequential ramp for a floored-at-zero R² surface. Categorical colour is
// carried by the category axis itself (S6), so the heatmap scale stays neutral.
const SEQ = [
  [0, '#FFFFFF'], [0.25, '#E5F5E0'], [0.5, '#A1D99B'],
  [0.75, '#41AB5D'], [1, '#00441B'],
];

// ---------------------------------------------------------------------------
// a. Reach of each category
// ---------------------------------------------------------------------------
