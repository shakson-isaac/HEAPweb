    ...
    <div>
      <div className="interactive-plot">
        <iframe
          ...
          src={`${process.env.REACT_APP_BACKEND_URL}/data/generic/GvEplot.html`} // Use relative URL
          width="600px"
          height="400px"
          frameBorder="0"
        />
      ...
      <div className="mt-8">
        ...
        <TableComponent
          csvFilePath={`${process.env.REACT_APP_BACKEND_URL}/fetch_data/GxE_R2table.csv`} // Use relative URL
        />
      </div>
    </div>
  );
